class Ui {
    ...
    $(".addToPlaylist").click(function() {
      ...
      if (!ui.firstAddClick) {
        ...
        if (!this.createdPlaylist) {
          var addPlaylist = $("<p>");
          addPlaylist.html(
            "Nie masz jeszcze żadnej playlisty. Stwórz ją wpisując jej nazwę w polu powyżej oraz klikając ikonkę obok."
          );
        ...
        $(".createPlaylistIcon").click(function() {
          ...
          $(".addPlaylist").html(
            "Możesz stworzyć nową playlistę lub dodać do istniejącej."
          );
        });
      } else {
        ui.song = $(this).attr("id");
  ...
  createPlaylist(playlists) {
    ...
    for (let i = 0; i < playlists.playlists.length; i++) {
      ...
      if (i == ui.selectedId) {
        console.log(
          "Zaznaczam jako aktywną wcześniej wybraną playlistę(Po dodaniu nowej)."
        );
  ...
  addEvents() {
    ...
    $(".openButton").click(function() {
      ...
      $(".addPlaylist").html(
        "Otwarto playlistę nr " + (parseInt(ui.selectedId) + 1) + "."
      );
    });
  }
    ...
    for (let i = 0; i < names.files.length; i++) {
      ...
      if (i == 0) {
        ...
        tr.append(
          $("<td>").html(
            $("<img>")
              .attr("id", names.dir + "/" + names.files[i].file)
              .addClass("playIt")
              .css({
                width: "30px",
                height: "30px"
